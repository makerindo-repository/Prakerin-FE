...
const NAV_GROUPS: Record<string, NavGroup[]> = {
  ...
  super_admin: [
    ...
    },
    {
      label: "MASTER DATA",
      items: [
        { icon: Map, label: "Data Provinsi", href: "/dashboard/master-data/provinsi" },
        { icon: Building2, label: "Data Kota/Kabupaten", href: "/dashboard/master-data/kota-kabupaten" },
        { icon: Factory, label: "Data Sektor Industri", href: "/dashboard/master-data/sektor" },
        { icon: CalendarClock, label: "Data Durasi Magang", href: "/dashboard/master-data/durasi" },
        { icon: GraduationCap, label: "Data Jurusan Siswa", href: "/dashboard/master-data/jurusan" },
        { icon: BriefcaseBusiness, label: "Data Bidang Magang", href: "/dashboard/master-data/bidang" },
        { icon: School, label: "Data Sekolah", isDev: true },
        { icon: School, label: "Data Perguruan Tinggi", isDev: true },
        { icon: Building, label: "Data Industri", href: "/dashboard/perusahaan" },
      ],
    },
    {
      label: "MANAJEMEN",
      items: [
        { icon: UsersRound, label: "Siswa", href: "/dashboard/school/daftarsiswa" },
        { icon: GraduationCap, label: "Mahasiswa", href: "/dashboard/school/daftarsiswa" },
        { icon: MapPin, label: "Penempatan", href: "/dashboard/school/penempatan" },
        { icon: BookOpen, label: "Kelas Pra-Magang", isDev: true },
        { icon: UserRound, label: "Pembimbing", href: "/dashboard/pembimbing", isDev: true },
        { icon: UsersRound, label: "Manajemen User", href: "/dashboard/master-data/users" },
      ],
    },
    {
      label: "KONTEN & KOMUNIKASI",
      items: [
        { icon: Newspaper, label: "Isi Halaman", href: "/dashboard/isi-halaman" },
        { icon: HelpCircle, label: "Panduan", isDev: true },
        { icon: MessageSquareText, label: "Feedback Pengguna", href: "/dashboard/feedback" },
      ],
    },
    {
      label: "MONITORING & LAPORAN",
      items: [
        { icon: ScrollText, label: "Laporan", isDev: true },
        { icon: Activity, label: "Log Aktivitas", isDev: true },
      ],
    },
    {
      label: "SISTEM",
      items: [
        { icon: Settings, label: "Pengaturan", isDev: true },
  ...
  company: [
    ...
    },
    {
      label: "MANAJEMEN",
      items: [
        { icon: UsersRound, label: "Siswa/Mahasiswa Magang", href: "/dashboard/siswa-magang" },
        { icon: HelpCircle, label: "Tes", href: "/dashboard/tes" },
        { icon: Briefcase, label: "Lowongan", href: "/dashboard/lowongan" },
        { icon: FileText, label: "Lamaran", href: "/dashboard/industry/lamaran" },
        { icon: ClipboardCheck, label: "Daftar Tugas", href: "/dashboard/tasklist" },
        { icon: BookOpen, label: "Sekolah/Universitas", href: "/dashboard/sekolah" },
        { icon: Handshake, label: "Kerja Sama", href: "/dashboard/mou" },
        { icon: Award, label: "Penghargaan", isDev: true },
        { icon: MessageSquareText, label: "Ulasan", href: "/dashboard/feedback" },
        { icon: Medal, label: "Sertifikat", href: "/dashboard/sertifikat" },
        { icon: UserRound, label: "Pembimbing Perusahaan", isDev: true },
        { icon: User, label: "Profil", href: "/dashboard/profile" },
      ],
    },
  ],
  ...
  school: [
    ...
    },
    {
      label: "MANAJEMEN",
      items: [
        { icon: UsersRound, label: "Daftar Siswa/Mahasiswa", href: "/dashboard/school/daftarsiswa" },
        { icon: MapPin, label: "Penempatan", href: "/dashboard/school/penempatan" },
        { icon: Building, label: "Perusahaan", href: "/dashboard/perusahaan" },
        { icon: Handshake, label: "Kerja Sama", href: "/dashboard/mou" },
        { icon: Award, label: "Penghargaan", isDev: true },
        { icon: MessageSquareText, label: "Ulasan", href: "/dashboard/feedback" },
        { icon: UserRound, label: "Guru Pembimbing", isDev: true },
        { icon: User, label: "Profil", href: "/dashboard/profile" },
      ],
    },
  ],
...
export default function DashboardLayout({
  ...
  // ── Compute visible nav groups (filter by active status) ──────────────────
  const visibleNavGroups = useMemo(() => {
    if (isActive) return navGroups;
    ...
    return navGroups
      .map((group) => {
        const filteredItems = group.items.filter(
          (item) => !isProtectedHref(item.href)
        );
