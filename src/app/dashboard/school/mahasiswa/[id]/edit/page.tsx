...
const EditSiswaPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        await alertError("Gagal mengambil data mahasiswa");
        router.push("/dashboard/school/mahasiswa");
      } finally {
  ...
  const handleSubmit = async (): Promise<void> => {
    ...
    try {
      ...
      await alertSuccess("Data mahasiswa berhasil diperbarui!", 1500);
      router.push("/dashboard/school/mahasiswa");
    ...
    <main className="p-6">
      ...
      <div className="mb-8">
        <div className="flex items-center space-x-2 font-extrabold text-accent">
          ...
          <h2 className="text-2xl mt-2">Ubah Mahasiswa</h2>
        </div>
      </div>
