                ...
                <div className="w-[88%] mx-auto pt-16 pb-20">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center mb-14">
                        ...
                        <div>
                            ...
                            <div className="inline-flex items-center gap-2 rounded-full bg-cyan-50 text-accent px-5 py-2 font-semibold">

                                <BookOpen size={18} />

                                Pusat Bantuan Prakerin.id

                            </div>

                            <h1 className="mt-7 text-6xl font-black leading-tight text-slate-900">
