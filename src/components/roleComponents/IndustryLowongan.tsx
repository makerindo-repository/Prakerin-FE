                ...
                <div className="flex items-start justify-between gap-3 mb-3">
                  ...
                  {data.poster && (
                    <a
                      ...
                      title="Buka poster lowongan ukuran penuh"
                      className="relative w-14 h-14 flex-shrink-0 rounded-lg overflow-hidden border border-gray-200 bg-gray-50 group/poster block hover:border-accent hover:shadow-xs transition-all cursor-pointer"
                    >
